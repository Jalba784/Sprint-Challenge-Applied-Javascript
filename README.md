...
3. What is an event listener? 
    ...
    An event listener reacts to an event. For example, if a listener is awaiting a click from the user's mouse it will lie dormant until the click is prompted. Once prompted the listener will enable a block of code that is triggered once the even takes place.

4. Why would we convert a NodeList into an Array? 

    In order to manipulate the data stored in the NodeList.
